    ...
    public static function renderCategoryLevelsAdd(array $categories, int $level = 0, array $path = []): string
    {
                ...
                if (is_string($key)) {
                    ...
                    $html .= <<<HTML
                                <li class="category-name flex justify-between items-center bg-gray-50 hover:bg-gray-100 rounded-lg px-4 py-2">
                                    <span @click="open = false; path = {$json_path}" class="cursor-pointer text-sm sm:text-base">{$item_name}</span>
                                    <div class="flex items-center gap-2">
                                        <button
                                            class="addCategories ml-2 w-16 sm:w-20 h-8 flex items-center justify-center border border-green-400 rounded-md text-lg sm:text-xl text-green-700 hover:bg-green-200 transition"
                                        ...
                                        <button
                                            class="ml-2 w-16 sm:w-20 h-8 flex items-center justify-center border border-gray-300 rounded-md text-lg sm:text-xl text-gray-600 hover:bg-gray-200 transition"
                    ...
                    foreach ($value as $leaf) {
                        ...
                        $html .= <<<HTML
                                    <li class="category-name flex justify-between items-center bg-green-50 hover:bg-green-100 rounded-lg px-4 py-2">
                                        <span @click="open = false; path = {$json_path}" class="cursor-pointer text-sm sm:text-base text-green-800 font-medium">{$item_name}</span>
                                        <button
                                            class="addCategories ml-2 w-16 sm:w-20 h-8 flex items-center justify-center border border-green-400 rounded-md text-lg sm:text-xl text-green-700 hover:bg-green-200 transition"
                                            data-name="{$item_name}" 
        ...
        $html .= <<<HTML
                    <li class="flex justify-center mt-2">
                        <button
                            class="w-full max-w-xs py-1.5 sm:py-2 border border-blue-500 rounded-md text-sm sm:text-base text-blue-600 hover:bg-blue-100 transition"
